  ...
  methods: {
    ...
    */
    ...
    reloadData() {
      ...
      // this.currentPage = 1
      this.$refs.tableVendor.loadAllData(1,queryString);
...
<!-- CREATE OR REPLACE FUNCTION public.func_create_payment(payment_id text, payment_code text DEFAULT NULL::text,
 payment_name text DEFAULT NULL::text, tax_code text DEFAULT NULL::text, phone_number text DEFAULT NULL::text,
land_line_number text DEFAULT NULL::text, website text DEFAULT NULL::text, contact_name text DEFAULT NULL::text,
  contact_legal_rep text DEFAULT NULL::text, contact_email text DEFAULT NULL::text, contact_phone_number text DEFAULT NULL::text,
  contract_id integer DEFAULT NULL::integer, max_debit_date integer DEFAULT NULL::integer,
  max_debit_amount double precision DEFAULT NULL::double precision, debit_receipt_account_id integer DEFAULT NULL::integer,
  debit_payment_account_id integer DEFAULT NULL::integer, country_id integer DEFAULT NULL::integer,
  province_id integer DEFAULT NULL::integer, district_id integer DEFAULT NULL::integer,
  ward_id integer DEFAULT NULL::integer, delivery_address text DEFAULT NULL::text,
  text_note text DEFAULT NULL::text, identity_date timestamp without time zone DEFAULT NULL::timestamp without time zone,
  identity_place text DEFAULT NULL::text, created_by text DEFAULT NULL::text,
  created_date timestamp without time zone DEFAULT NULL::timestamp without time zone, 
  modified_by text DEFAULT NULL::text, modified_date timestamp without time zone DEFAULT NULL::timestamp without time zone, 
  bank text DEFAULT NULL::text, prefix_name_id integer DEFAULT NULL::integer, payment_type integer DEFAULT NULL::integer, 
  is_customer boolean DEFAULT NULL::boolean, identity_number text DEFAULT NULL::text, address text DEFAULT NULL::text, 
  payment_group text DEFAULT NULL::text, employee_id text DEFAULT NULL::text, is_owed boolean DEFAULT NULL::boolean, 
  is_used boolean DEFAULT NULL::boolean)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
declare 
	_max_debit_amount numeric;
begin
    ...
    payment_code,                  
		...
		max_debit_date,  
		max_debit_amount,
		debit_receipt_account_id,                                           
	  	debit_payment_account_id,                                           
	  	country_id,                
		province_id,                  
		district_id,                  
		ward_id,          
		...
		is_used) 
	VALUES( 
		func_create_payment.payment_id,
		func_create_payment.payment_code,                  
		func_create_payment.payment_name,                  
		func_create_payment.tax_code,            
		func_create_payment.phone_number,                    
		func_create_payment.land_line_number,                            
		func_create_payment.website,          
		func_create_payment.contact_name,                    
		func_create_payment.contact_legal_rep,                              
		func_create_payment.contact_email,                      
		func_create_payment.contact_phone_number,                                    
		func_create_payment.contract_id,                
		func_create_payment.max_debit_date,  
		cast (func_create_payment.max_debit_amount as numeric ),
		func_create_payment.debit_receipt_account_id,                                           
	  	func_create_payment.debit_payment_account_id,                                           
	  	func_create_payment.country_id,                
		func_create_payment.province_id,                  
		func_create_payment.district_id,                  
		func_create_payment.ward_id,          
		func_create_payment.delivery_address,                            
		func_create_payment.text_note,              
		func_create_payment.identity_date,                      
		func_create_payment.identity_place,                        
		func_create_payment.created_by,                
		now(),             
		func_create_payment.modified_by,                  
		func_create_payment.modified_date,
		func_create_payment.bank,    
		func_create_payment.prefix_name_id,                       
	  	func_create_payment.payment_type,                 
	  	func_create_payment.is_customer,                 
	  	func_create_payment.identity_number,                          
		func_create_payment.address,          
		func_create_payment.payment_group,
		func_create_payment.is_owed,
		func_create_payment.is_used);
    return found;
END;
$function$
; -->
