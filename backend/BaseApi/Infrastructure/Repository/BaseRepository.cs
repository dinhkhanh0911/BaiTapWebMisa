...
using static Base.WebApi.Core.Attributies.CustomAttribute;
...
namespace MISA.Infrastructure.Respository
{
    ...
    public class BaseRepository<T>:IBaseRepository<T>
    {
        ...
        {
            _sqlConnectionString = "Server=localhost;Port=3306;Database=vn.address;User Id=root;Password=09112000";
            //_sqlConnectionString = "Host=localhost;Port=3306;Database=m;User Id=admin;Password=Anhtoankt12@";   
        }
        #endregion
        #region Methods
        /// <summary>
        ...
        /// <returns></returns>
        /// Author: Nguyễn Đức Toán-MF1095 (13/04/2022)
        public virtual int MultiDelete(List<int> listId)
        {
            var entityName = typeof(T).Name;
            //khởi tạo kết nối
            var sqlConnection = new MySqlConnection(_sqlConnectionString);
